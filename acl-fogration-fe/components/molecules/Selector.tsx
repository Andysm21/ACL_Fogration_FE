...
>((props, ref) => {
  ...
  function currency(){
    if(props.selectedValue.value == "US"){
      localStorage.setItem("currency", "$");
      return "$"
    }
    else if (props.selectedValue.value == "DE"){
      localStorage.setItem("currency", "€");
      return "€"
    }

    else if (props.selectedValue.value == "EG"){
      localStorage.setItem("currency", "£");
      return "£"
    }
  ...
  return (
    <div ref={ref}>
      <div className="mt-1 relative">
        <button
          type="button"
          className="bg-white relative w-44 border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
