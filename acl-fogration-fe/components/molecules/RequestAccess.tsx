...
const RequestAccess: React.FC<Props> = ({ handleClose, isOpen }) => {
  ...
  return (
    <div className="">
      ...
      >
        ...
        id="responsive-dialog-title">{"Request confirmation"}
        </DialogTitle>
      ...
      id="demo-row-radio-buttons-group-label">
        ...
        Are you sure you would like to take the course? The request will be sent to an administrator for a review
        </div>
        </FormLabel>
    </FormControl>
                    </div>
