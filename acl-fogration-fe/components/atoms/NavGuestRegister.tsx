...
const NavGuestRegister = () => {
  ...
  return (
    <div className="fixed z-40 flex h-16 w-full flex-row items-center justify-between bg-transparent shadow-lg px-4">
...
export default NavGuestRegister;
